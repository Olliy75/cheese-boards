...
const board = await Board.bulkCreate([
    {
        type: "cheesy",
        description: "its just cheese",
        rating: 5
    },
    {
        type:"less cheesy",
        description:"a smidge less cheese than cheesey",
        rating:6
    },
    {
        type:"more cheesy",
        description:"idk how but they added more cheese",
        rating:4
    },
    {
        type:"not cheese shhhhh",
        description:"its a cheese board without the cheese",
        rating:3
    },
    {
        type:"The Cracker Stacker",
        description:"its mostly crackers tbh",
        rating:7
    }
    ])
...
await user.addBoard(board[1])
await user.addBoard(board[2])
await user.addBoard(board[0])


await board[0].addCheese(cheese[0])
await board[0].addCheese(cheese[1])
await board[0].addCheese(cheese[2])
